...
2) download the dataset **Activity monitoring data** [52K] required for this assignment.  
https://d396qusza40orc.cloudfront.net/repdata%2Fdata%2Factivity.zip

Description of this data from course website: 
...
3) Read this data into a dataframe and inspect the structure of the data
...
4) Create a histogram of the total number of steps taken each day; summarize the data by day:
...
```r
#Making The Generation of This Plot Into A Function to Re-use Later
